...
const
  AccessLib : array[tKindAccess] of string = ('création', 'dernier accès', 'modification');
  PeriodLib : array[tKindPeriod] of string  = ('jour', 'semaine', 'mois', 'année');
...
procedure tTask.SetTraceFile(const value: string);
begin
  fTraceFile := Value;
  bTraceFile := true;
end;
